...
<div class="control-group">
    ...
    <div class="controls">
        <input type="password" name="payment_data[processor_params][shared_secret]" id="shared_secret" value="{$processor_params.shared_secret}" autocomplete="new-password"  size="60">
    </div>
</div>
