...
<div class="table-responsive-wrapper">
    ...
    <tr class="table-row" id="box_new_product">
        ...
        <td data-th="{__("price")}"><input type="text" name="products_data[0][price]" size="4" value="0.00" class="input-mini" /></td>
        <td data-th="{__("list_price_short")}"><input type="text" name="products_data[0][list_price]" size="4" value="0.00" class="input-mini" /></td>
