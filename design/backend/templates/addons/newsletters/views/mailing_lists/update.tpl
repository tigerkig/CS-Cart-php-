...
<form action="{""|fn_url}" method="post" enctype="multipart/form-data" name="mailing_lists_form_{$id}" class="form-horizontal form-edit ">
...
<div class="buttons-container">
    {include file="buttons/save_cancel.tpl" but_name="dispatch[mailing_lists.update]" cancel_action="close" save=$id cancel_meta="bulkedit-unchanged"}
</div>
