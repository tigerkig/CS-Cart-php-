...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'ebay.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('ebay.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'ebay_templates_form',
                'data-ca-target-form' => '#ebay_templates_form',
            ],
        ],
        'position' => $position,
    ];
