...
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp, position) VALUES(20, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()) - 1000, 0);
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp, position) VALUES(21, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()) - 1000, 0);
REPLACE INTO ?:banners (banner_id, status, type, target, timestamp, position) VALUES(22, 'A', 'G', 'T', UNIX_TIMESTAMP(NOW()) - 1000, 0);
