...
class QgbcWap implements IFormPayment
{
    /**
     * @var array $settings
     */
    ...
    {
        return $charge['credential'][Channels::QGBC_WAP]['url'];
    }

    /** @inheritdoc */
    public function getFormData(array $charge)
    {
        unset($charge['credential'][Channels::QGBC_WAP]['url']);

        return $charge['credential'][Channels::QGBC_WAP];
    }
